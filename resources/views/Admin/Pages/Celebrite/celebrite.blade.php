...
@section('title', 'Dashboard - Celebrite')
@section('content')
    ...
    <div class="page-breadcrumb border-bottom">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-xs-12 d-flex align-items-center">
                <h5 class="font-weight-bold text-uppercase mb-0">Celebrite</h5>
            </div>
            <div class="col-lg-9 col-md-8 col-xs-12 d-flex justify-content-md-end justify-content-start align-self-center">
                <nav aria-label="breadcrumb" class="mt-2">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Celebrite</li>
                    </ol>
                </nav>
                <a href="{{ route('create.celebrite') }}"
            ...
            <div class="col-12">
                <div class="card shadow-lg border-0">
                    <div class="border-bottom title-part-padding bg-light">
                        <h4 class="card-title mb-0 text-center text-uppercase">Liste des articles des célébrités sportives</h4>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-sm btn-info ms-2 ml-8" data-bs-toggle="modal" data-bs-target="#commentsModal{{ $article->id }}">
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('articles.show.celebrite', $article->slug) }}" target="_blank"
                                    ...
                                    <div class="modal fade" id="editModal{{ $article->id }}" tabindex="-1" aria-hidden="true" data-bs-focus="false">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('celebrite.update', $article->id) }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
                                    ...
                                    <div class="modal fade" id="deleteModal{{ $article->id }}" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('celebrite.destroy', $article->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <div class="modal-body">
