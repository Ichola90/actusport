                ...
                <div class="card shadow-lg rounded-3">
                    <div class="border-bottom title-part-padding bg-light">
                        <h4 class="card-title mb-0">
                            <i class="mdi mdi-newspaper-variant-outline"></i>Mercato | Ajouter une Actualité
                        </h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('store.mercato') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <select name="categorie" id="categorie" class="form-control" required>
                                ...
                                <option value="afrique" {{ old('categorie', $mercato->categorie ?? '') == 'afrique' ? 'selected' : '' }}>Afrique</option>
                                <option value="europe" {{ old('categorie', $mercato->categorie ?? '') == 'europe' ? 'selected' : '' }}>Europe</option>
                            </select>
                            <!-- Contenu -->
                            <div class="mb-3">
                                <label for="content" class="form-label fw-bold">Contenu</label>
                                <textarea name="content" id="editor" rows="20" class="form-control" placeholder="Écrivez votre article..."></textarea>
                            </div>
                            <!-- Mots-clés -->
