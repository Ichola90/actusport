    ...
    <div class="page-breadcrumb border-bottom">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-xs-12 d-flex align-items-center">
                <h5 class="font-weight-bold text-uppercase mb-0">Mercato</h5>
            </div>
            <div class="col-lg-9 col-md-8 col-xs-12 d-flex justify-content-md-end justify-content-start align-self-center">
                <nav aria-label="breadcrumb" class="mt-2">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Mercato</li>
                    </ol>
                </nav>
                <a href="{{ route('add.mercato') }}"
            ...
            <div class="col-12">
                <div class="card shadow-lg border-0">
                    <div class="border-bottom title-part-padding bg-light">
                        <h4 class="card-title mb-0 text-center text-uppercase">Liste des articles Mercato</h4>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 20px;">
                                            <h4>{{ Str::limit(strip_tags($article->title), 20) }}
                                                <h4>
                                        </td>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-xl">
                                                    ...
                                                    <div class="modal-body d-flex justify-content-center align-items-center p-0">
                                                        <img src="{{ asset($article->image) }}"
                                                            ...
                                                            style="max-height: 90vh; width: auto; width: 600 px; height: 600px;">
                                    ...
                                    <div class="modal fade" id="deleteModal{{ $article->id }}" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('mercato.destroy', $article->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
    ...
    <div class="modal fade" id="editModal{{ $article->id }}" tabindex="-1" aria-hidden="true" data-bs-focus="false">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('mercato.update', $article->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="modal-body">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="categorie" class="form-control" required>
                                ...
                                <option value="afrique" {{ $article->categorie == 'afrique' ? 'selected' : '' }}>Afrique</option>
                                <option value="europe" {{ $article->categorie == 'europe' ? 'selected' : '' }}>Europe</option>
                            </select>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            tinymce.init({
                ...
                toolbar: 'undo redo | blocks | bold italic underline | bullist numlist | alignleft aligncenter alignright | link image table | code fullscreen | paste_text',
                branding: false,

                setup: function(editor) {
                    // Bouton pour coller en texte brut
                    editor.ui.registry.addButton('paste_text', {
                        text: 'Coller en texte brut',
                        onAction: function() {
                            navigator.clipboard.readText().then(function(text) {
                                editor.insertContent(text);
                            }).catch(function(err) {
                                alert('Impossible de coller depuis le presse-papiers : ' + err);
                            });
                        }
                    });
                }
