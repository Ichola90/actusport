    ...
    <div class="breadcrumbs">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active current">Actualités Sportives / Europe</li>
            </ol>
        </nav>
    </div>

    <div class="title-wrapper">
        <h1 style="color: #7ed957;">Actualités Sportives - Europe</h1>
        <p>Retrouvez toutes les dernières actualités sportives, résultats et analyses du continent européen.</p>
    </div>
</div>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <p class="post-views mb-0 d-flex align-items-center gap-2">
                <i class="bi bi-eye"></i> {{ $article->views }}
                    ...
                    @empty
                    <p>Aucune actualité sportive pour la catégorie Europe pour le moment.</p>
                    @endforelse
                </div>
