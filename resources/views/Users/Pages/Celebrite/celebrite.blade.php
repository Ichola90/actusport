...
@section('title','Celebrite sportives')
@section('content')
@php
use Carbon\Carbon;
    ...
    <div class="breadcrumbs">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active current">Célébrités sportives</li>
            </ol>
        </nav>
    </div>

    <div class="title-wrapper">
        <h1 style="color: #7ed957;">Célébrités sportives</h1>
        <p>Découvrez l’univers fascinant des personnalités qui font vibrer le monde du sport, entre tendances, événements marquants et actualités exclusives.</p>
    </div>
                ...
                <div class="col-lg-6">
                    <article>
                        <div class="post-img position-relative">
                            ...
                            @else
                                <img src="https://via.placeholder.com/600x400?text=Celebrité" alt="No Image" class="img-fluid">
                            @endif
                            ...
                            <h6 class="post-category position-absolute text-white px-2 py-1"
                                ...
                                Célébrité sportive / {{ $article->category ?? 'Célébrité sportive' }}
                            </h6>
                        </div>

                        <h2 class="title">
                            <a href="{{ route('articles.show.celebrite', $article->slug) }}">{{ $article->title }}</a>
                        </h2>
                ...
                <div class="recent-posts-widget widget-item mt-4">
                    ...
                    <div id="recentPostsContainer">
                        ...
                        <div class="post-item d-flex mb-3">
                            ...
                            <div class="post-info">
                                <h4 class="post-title"> <a href="{{ route('articles.show.celebrite', $post->slug) }}">{{ $post->title }}</a></h4>
