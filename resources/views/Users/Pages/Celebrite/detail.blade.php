    ...
    <div class="breadcrumbs">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active current">Célébrités / Details</li>
            </ol>
        </nav>
    </div>
            ...
            <div class="widgets-container">
                ...
                <div class="recent-posts-widget widget-item mt-4">
                    ...
                    <div class="post-item d-flex mb-3">
                        ...
                        <div>
                            <h4><a href="{{ route('articles.show.celebrite', $post->slug) }}">{{ Str::limit($post->title, 30) }}</a></h4>
                            <p style="font-size: 0.85rem; color: #555;">{{ $postAuthorName }}</p>
