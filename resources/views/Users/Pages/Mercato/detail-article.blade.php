...
<style>
    .hero-img-wrapper {
        ...
        /* important pour que le h6 reste sur l'image */
        width: 100% !important;
    ...
    .hero-article-img {
        ...
        /* rectangulaire desktop */
        object-fit: cover !important;
        /* recadrage automatique */
        display: block !important;
        border-radius: 0 !important;
        /* supprime tout arrondi */
    }
    ...
    <div class="breadcrumbs">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active current">Mercato / detail</li>
            </ol>
        </nav>
    </div>
                    ...
                    <div class="article-content mt-2" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="author-info d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div class="post-meta d-flex align-items-center gap-3" style="font-size: 0.9rem; color: #555;">
                                <span class="date d-flex align-items-center gap-2">
                        ...
                        {{-- Bio auteur --}}
                        <div class="author-bio mt-5 p-3 rounded shadow-sm"
                            style="background: #f9f9f9; border-left: 4px solid #7ed957;">
            ...
            <div class="widgets-container">
                ...
                <div class="recent-posts-widget widget-item mt-4">
                    ...
                    <div class="post-item d-flex mb-3">
                        ...
                        <div>
                            <h4><a href="{{ route('articles.show', $post->slug) }}">{{ Str::limit($post->title, 30) }}</a></h4>
