    ...
    <div class="breadcrumbs">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active current">Mercato -Afrique</li>
            </ol>
        </nav>
    </div>

    <div class="title-wrapper">
        <h1 style="color: #7ed957;">Mercato - Afrique</h1>
        <p>Retrouvez toutes les dernières informations, transferts et analyses sur le mercato africain.</p>
    </div>
</div>
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <section id="category-postst" class="category-postst section">
                <div class="row gy-4">
                    @foreach($articlesafrique as $article)
                    @php
                    ...
                    <div class="col-lg-6">
                        <article>
                            ...
                            <div class="d-flex align-items-center" style="justify-content: space-between; gap: 2px;">
                ...
                <!-- Pagination -->
                <div class="mt-4">
                    {{ $articlesafrique->links('pagination::bootstrap-5') }}
                </div>
            </section>
        </div>
