    ...
    <div class="breadcrumbs">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active current">Omnisport</li>
            </ol>
        </nav>
    </div>

    <div class="title-wrapper">
        <h1 style="color: #7ed957;">Omnisport</h1>
        <p>Plongez au cœur de l’actualité sportive avec des analyses pointues, des résultats en temps réel et des événements marquants qui rythment le monde du sport, tous disciplines confondues.</p>
    </div>
                    ...
                    <div class="col-lg-6">
                        <article>
                            <div class="post-img position-relative">
                                ...
                                @else
                                <img src="https://via.placeholder.com/600x400?text=Omnisport" alt="No Image" class="img-fluid">
                                @endif
                                ...
                                <h6 class="post-category position-absolute text-white px-2 py-1"
                                    ...
                                    Omnisport / {{ $article->category ?? 'Omnisport' }}
                                </h6>
                            </div>

                            <h2 class="title">
                                <a href="{{ route('articles.show.omnisport', $article->slug) }}">{{ $article->title }}</a>
                            </h2>
                ...
                <div class="recent-posts-widget widget-item mt-4">
                    ...
                    <div id="recentPostsContainer">
                        ...
                        <div class="post-item d-flex mb-3">
                            ...
                            <div class="post-info">
                                <h4 class="post-title"> <a href="{{ route('articles.show.omnisport', $post->slug) }}">{{ $post->title }}</a></h4>
